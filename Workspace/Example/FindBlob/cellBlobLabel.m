...
figure(),imshow(originalImage),title('Contrasted ORIGINAL IMAGE ');
binaryImage=imbinarize(originalImage);
figure(),imshow(originalImage),title('Binary Image ');
binaryImage=imfill(binaryImage,'holes');
figure(),imshow(binaryImage),title('Fill Image Pixels  ')




% binaryImage = originalImage > thresholdValue; % ( > ) for  Bright objects ,  ( < ) for  Dark objects 
% ========== IMPORTANT OPTION ============================================================
