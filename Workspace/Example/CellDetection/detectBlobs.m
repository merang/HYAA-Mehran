...
ref_img = imbinarize(I);   

%ref_img = imread('cell1.png');

ref_pts = detectSURFFeatures(ref_img);
[ref_features,  ref_validPts] = extractFeatures(ref_img,  ref_pts);
...
%% Compare 1st image to 2nd image  
